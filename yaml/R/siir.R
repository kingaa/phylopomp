...
runSIIR <- function (
  time, t0 = 0,
  Beta1 = 5, Beta2 = 5, gamma = 1, psi1 = 1, psi2 = 0, sigma12 = 0, sigma21 = 0, omega = 0, dt = 0.1, S0 = 500, I1_0 = 10, I2_0 = 10, R0 = 0
) {
  params <- c(Beta1=Beta1,Beta2=Beta2,gamma=gamma,psi1=psi1,psi2=psi2,sigma12=sigma12,sigma21=sigma21,omega=omega,dt=dt)
...
continueSIIR <- function (
  object, time,
  Beta1 = NA, Beta2 = NA, gamma = NA, psi1 = NA, psi2 = NA, sigma12 = NA, sigma21 = NA, omega = NA, dt = NA
) {
  params <- c(
    Beta1=Beta1,Beta2=Beta2,gamma=gamma,psi1=psi1,psi2=psi2,sigma12=sigma12,sigma21=sigma21,omega=omega,dt=dt
  )
